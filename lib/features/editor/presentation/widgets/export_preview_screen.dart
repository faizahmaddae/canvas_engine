...
///   * This screen is THE decision point: the sheet configures and
///     opens the preview; Save (primary) and Share (secondary) are
///     chosen here, with the file on screen. Cancel is the header ×
///     alone — a third button restating it made the action bar read
///     as a second questionnaire.
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            // Action bar — the ONE decision point of the export flow:
            // Share (quiet) beside Save (primary). No Cancel button;
            // the header × is the single leave-without-exporting
            // affordance. Three buttons here after two on the sheet
            // read as being asked the same question twice.
            Padding(

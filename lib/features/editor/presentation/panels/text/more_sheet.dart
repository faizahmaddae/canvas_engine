...
class _TextMoreSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      ...
      // Compact density across every row — the sheet is an action
      // list, not a settings screen; ~8dp per row buys the shorter
      // devices two extra visible rows.
      child: ListTileTheme(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              // B / I / U — one segmented toggle row; taps stay inline
              // so the user can flip multiple flags before dismissing.
              _InlineStyleToggleRow(layer: layer, parentRef: parentRef),
              const Divider(height: 1),
              ListTile(

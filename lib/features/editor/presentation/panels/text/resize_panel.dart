// Resize panel (Phase 2A commit 5): extracted verbatim from the
// text_mode_toolbar part-file library (text_resize_tiles.dart). Rename-only
...
class ResizeOptionTile extends StatelessWidget {
  const ResizeOptionTile({
    super.key,
    required this.icon,
    required this.title,
    required this.hint,
...
/// Compact radio dot used by [ResizeOptionTile]. Plain outline ring

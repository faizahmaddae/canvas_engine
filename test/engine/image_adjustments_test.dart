...
void main() {
  group('ImageAdjustments.colorMatrix — equivalence with prior composition', () {
  ...
  group('ImageAdjustments.colorMatrix — cache independence', () {
    ...
    test('copyWith produces a fresh cache slot, leaving the source untouched',
        () {
    ...
    test('two instances with equal field values still compute independent caches',
        () {

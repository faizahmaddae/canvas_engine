...
/// non-empty. The gate's contract: every fixture in this folder
/// must decode then re-encode to byte-identical output. Any future
/// schema bump (v4+) must keep these files round-tripping or
/// version itself out via the min-version writer (see
/// `DocumentCodec._writerVersion`).
